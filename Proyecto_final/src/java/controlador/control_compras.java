            ...
            if (menu.equals("Compras")) {
                ...
                switch (accion) {
                    case "modificar":
                        ...
                        compras.modificar();
                        Thread.sleep(2000);
                        response.sendRedirect("index_compras.jsp");
                        break;
            ...
            if (menu.equals("Compras_detalle")) {
                ...
                switch (accion) {
                    ...
                    case "eliminar2":
                        ...
                        if(detalle.modificacion_eliminar()>0)
                        {
                        int Id_venta2 = Integer.valueOf(request.getParameter("txt_id_detalle"));
                        detalle.eliminar_detalle(Id_venta2);
                        Thread.sleep(2000);
                    ...
                    /*case "modificar2":
                        //detalle = new Detalle_compra(Integer.valueOf(request.getParameter("txt_id_detalle")), Integer.valueOf(request.getParameter("No_compra")), 0, 0, Integer.valueOf(request.getParameter("drop_prod")), Integer.valueOf(request.getParameter("cantidad_detalle")), 0.0, "", 0.0);
                        detalle = new Detalle_compra(Integer.valueOf(request.getParameter("txt_id_detalle")), Integer.valueOf(request.getParameter("No_compra")), 0, 0, Integer.valueOf(request.getParameter("drop_prod")), Integer.valueOf(request.getParameter("cantidad_detalle")), Double.valueOf(request.getParameter("precio_unitario")), "", 0.0);
