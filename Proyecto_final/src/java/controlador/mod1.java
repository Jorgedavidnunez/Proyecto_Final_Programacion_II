            ...
            try {
                ...
                for (int i = 0; i < items2.size(); i++) {
                    ...
                    if (!fileItem.isFormField()) {
                        ...
                        File f = new File("C:\\Users\\david\\Desktop\\Cuarto Semestre\\Programación II\\Semana 18\\Proyecto_final\\Proyect_web-main\\Proyecto_final\\web\\i\\" + fileItem.getName());
                        fileItem.write(f);
                        //pr.setImagen("/Formulario_prueba/img/" + fileItem.getName());
                        pr.setImagen("/Pro_final/i/" + fileItem.getName());
                    } else {
