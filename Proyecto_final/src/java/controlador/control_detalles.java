...
public class control_detalles extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ("eliminar2".equals(request.getParameter("btn_eliminar2"))) {
                detalle.setId(Integer.valueOf(request.getParameter("txt_id_detalle")));
                detalle.setIdventa(Integer.valueOf(request.getParameter("txt_id_detalle")));
                detalle.setIdproducto(Integer.valueOf(request.getParameter("drop_prod")));
                int cantidad_de_ventas= detalle.cantidad_de_ventasdetalle();
                detalle.modificacion_antiguoidprod(cantidad_de_ventas);
