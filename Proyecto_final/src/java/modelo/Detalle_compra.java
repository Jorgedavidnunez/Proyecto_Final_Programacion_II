...
public class Detalle_compra {
     ...
     /*public int modificar()
    {
        ...
        try
        {
            ...
            modificar_costo_prod(getPrecio());
            cn.cerrarCon();
        }catch(SQLException ex)
        {
     ...
     public int modificar_costo_prod(double cantidad)
    {
     ...
     public int modificar_costo_prod(double cantidad)
    {
        ...
        {
            PreparedStatement parametro;
            String codigo_sql="update db_punto_venta.productos set Precio_costo=?, Precio_venta=? where idProducto=?";
            cn = new Conexion();
            cn.abrirCon();
            parametro=(PreparedStatement) cn.conexiondb.prepareStatement(codigo_sql);
