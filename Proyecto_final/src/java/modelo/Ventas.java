    ...
    public DefaultTableModel leer3() {
     ...
     /*public DefaultTableModel leer3() {
        ...
        try {
            cn = new Conexion();
            cn.abrirCon();
            String query = "select v.idVenta as id,v.No_factura,v.Serie,v.Fecha_factura,c.Nombres,e.Nombres,v.Fecha_ingreso,v.Idcliente,v.idempleado from ventas as v inner join clientes as c on v.Idcliente = c.idCliente inner join empleados as e on v.idempleado = e.idEmpleado; ";
            ResultSet consulta = cn.conexiondb.createStatement().executeQuery(query);
            String encabezado[] = {"Id", "No", "serie", "fechafact", "cliente", "empleado", "fecha"};
            tabla.setColumnIdentifiers(encabezado);
            String datos[] = new String[7];
            while (consulta.next()) {
                ...
                datos[2] = consulta.getString("Serie");
                datos[3] = consulta.getString("Fecha_factura");
                datos[4] = consulta.getString("c.Nombres");
                datos[5] = consulta.getString("e.Nombres");
                datos[6] = consulta.getString("Fecha_ingreso");
