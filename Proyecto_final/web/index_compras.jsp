                    ...
                    <div class="modal-content formula_modal">
                        ...
                        <div class="modal-body ">
                            <form action="control_compras?menu=Compras_detalle" class="formulario" method="post"  >
                                ...
                                <div class="formulario__grupo">
                                    <label for="cantidad" class="formulario__label">Precio Unitario</label>
                                    <div class="formulario__grupo-input">
                                        <input type="number" class="formulario__input" name="precio_unitario" id="precio_unitario" value="0" >
                                    </div>
                                </div>       
                                        <br>
                ...
                <div class="parent2 ">
                    ...
                    <div class="div_tres">
                        ...
                        <div class="" id="grupo__txt_precio">
                            ...
                            <div class="formulario__grupo-input">
                                <input type="number" step="0.1" class="producto_input " value="${proo.getPrecio()}" name="precio" id="precio"  > <!--readonly-->
                            </div>
                        </div> 
                    </div>
            ...
            <div class="casa26 parte2">
                ...
                <div class="blanco">
                    ...
                    <div class="card-footer d-flex">
                        <button id="accion" name="accion" value="Agregar_compra" class="nekros" >Agregar Compra </button>
